...
ftp_username = "charingsherwick"  #RegularAccount
...
#log_destination = "/logfiles/6900Sherwick"
#log_destination = "/logfiles/6975Charing"
#log_destination = "/logfiles/6808Charing"

base_location = "/home/pi/camera/"
...
save_yesterday_log_clocktime = "2:00"   #24 hour time running - For saving yesterday's log
save_yesterday_log_clocktime = "20:04"   #24 hour time running - For saving yesterday's log


#This Parameter is needed so that Dreamhost does not get more than 9 FTP processes at once

max_threads = 3 # max number of total threads when needed one thread will be used for purging job, rest of time all threads will be used for upload.
